#author: Saurav Rai
#dataloader class for the MORPH Dataset
...
class AgeFaceDataset(Dataset):
    def __init__(self, transform = None, istrain = False, isvalid = False):
        ...
        self.metafile = os.path.join('', 'age_identity_cnn_morph_metafile.pkl')  
        self.root_path = '/home/titanx/DB/Morph_preprocess/MorphProcessed/'
        ...
        ''' CHANEGD MADE BY SAURAV RAI
            for (key,value) in self.morph_dict.items():
            self.allist.append([key, value[0], value[1]])
        '''
        ...
        #    self.validlist.append([i, self.allist[i][2]])  #old faces for 0-1999 with label
    ...
    def __getitem__(self, i):
        ...
        if self.istrain is False and self.isvalid is False:    #Test set both young and old
            ...
            #print('gallery age and probe age:',gallery_age,probe_age)
